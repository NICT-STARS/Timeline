...
/*-----* variable *-----------------------------------------------------------*/
    ...
    $bar.children().each(function(pIndex, pElement)
    {
      ...
      else if (intScale <= 1000 * 60 *  2.5)
      {
        if (typeof strLabelPosition == "string" && strLabelPosition == "range")
        {
          intWidth = (1000 * 60 * 60 *  3) / intScale;
      ...
      else if (intScale <= 1000 * 60 *  5)
      {
        if (typeof strLabelPosition == "string" && strLabelPosition == "range")
        {
          intWidth = (1000 * 60 * 60 *  6) / intScale;
      ...
      else if (intScale <= 1000 * 60 * 10)
      {
        if (typeof strLabelPosition == "string" && strLabelPosition == "range")
        {
          intWidth = (1000 * 60 * 60 * 12) / intScale;
      ...
      else if (intScale <= 1000 * 60 * 60)
      {
        if (objTime.getUTCHours() == 0)
        {
          if (typeof strLabelPosition == "string" && strLabelPosition == "range")
          {
            objNext  = new Date(objTime.getTime()); if (objTime.getUTCDate() == 26) objNext.setUTCMonth(objNext.getUTCMonth() + 1, 1); else objNext.setUTCDate(objNext.getUTCDate() + 5);
      ...
      else if (intScale <= 1000 * 60 * 60 *  2)
      {
        if (objTime.getUTCDate() < 31 && objTime.getUTCDate() % 15 == 1)
        {
          if (typeof strLabelPosition == "string" && strLabelPosition == "range")
          {
            objNext  = new Date(objTime.getTime()); if (objTime.getUTCDate() == 1) objNext.setUTCDate(objNext.getUTCDate() + 15); else objNext.setUTCMonth(objNext.getUTCMonth() + 1, 1);
            intWidth = (objNext.getTime() - objTime.getTime()) / intScale;
      ...
      else if (intScale <= 1000 * 60 * 60 * 18)
      {
        if (objTime.getUTCDate() == 1)
        {
          if (typeof strLabelPosition == "string" && strLabelPosition == "range")
          {
            objNext  = new Date(objTime.getTime()); objNext.setUTCMonth(objNext.getUTCMonth() + 3);
            intWidth = (objNext.getTime() - objTime.getTime()) / intScale;
      ...
      else if (intScale <= 1000 * 60 * 60 * 24 *  3)
      {
        if (objTime.getUTCDate() == 1)
        {
          if (typeof strLabelPosition == "string" && strLabelPosition == "range")
          {
            objNext  = new Date(objTime.getTime()); objNext.setUTCMonth(objNext.getUTCMonth() + 6);
            intWidth = (objNext.getTime() - objTime.getTime()) / intScale;
      ...
      else if (intScale <= 1000 * 60 * 60 * 24 * 30)
      {
        if (objTime.getUTCFullYear() % 5 == 0)
        {
          if (typeof strLabelPosition == "string" && strLabelPosition == "range")
          {
            objNext   = new Date(objTime.getTime()); objNext.setUTCFullYear(objNext.getUTCFullYear() +  5);
            intWidth  = (objNext.getTime() - objTime.getTime()) / intScale;
            strFormat = flgJpCalendar ? "%jp年~" : "%y~";
          }
          else
      ...
      else
      {
        if (objTime.getUTCFullYear() % 10 == 0)
        {
          if (typeof strLabelPosition == "string" && strLabelPosition == "range")
          {
            objNext   = new Date(objTime.getTime()); objNext.setUTCFullYear(objNext.getUTCFullYear() + 10);
            intWidth  = (objNext.getTime() - objTime.getTime()) / intScale;
            strFormat = flgJpCalendar ? "%jp年~" : "%y";
          }
          else
