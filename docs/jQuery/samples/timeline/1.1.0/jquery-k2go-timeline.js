...
/******************************************************************************/
    ...
    $this.k2goTimeline("create", null, pCallback);
  },
/******************************************************************************/
/* setOptions                                                                 */
/******************************************************************************/
...
/* create                                                                     */
/******************************************************************************/
  create : function(pTimeInfo, pCallback)
  {
    var $main = $(".k2go-timeline-main");

    if (typeof pTimeInfo == "object" && pTimeInfo != null)
    {
    ...
    if (typeof pCallback == "function") setTimeout(function() { pCallback(_getTimeInfo()); }, 1);
  },
/******************************************************************************/
/* zoom                                                                       */
/******************************************************************************/
